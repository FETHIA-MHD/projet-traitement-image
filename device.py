...
img=imageio.imread("device.jpg").tolist()
print(len(img))
print(img[4][122])
print(len(img[4]))
...
image = cv2.imread('device1.jpg', cv2.IMREAD_GRAYSCALE)
...
print("les coefficient de la 2° partie est ::",fil1)
print("les coefficient de la 3° partie est::",fil2)
print("le coefficient de la 4° partie est::",fil3)
print("le coefficient de la 5° partie est::",fil4) 
